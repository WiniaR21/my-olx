...
public class AccountsController {
    ...
    public ResponseEntity<?> updateAccount(@RequestBody CreateAccountRequest request){
    ...
    public ResponseEntity<AccountDetails> fetchAccountByPhoneNumber(@RequestParam String phoneNumber){
        return ResponseEntity
                .ok()
                .body(accountsService.fetchAccountByPhoneNumber(phoneNumber));
    }
    @GetMapping(path = "/fetch-by-email")
    public ResponseEntity<AccountDetails> fetchAccountByEmail(@RequestParam String email){
        return ResponseEntity
                .ok()
